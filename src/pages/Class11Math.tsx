...
const Class11Math = () => {
  return (
    <>
      <Helmet>
        <title>Class 11 Math Tutor in Kolkata | CBSE ISC WBCHSE | Sucheta's Math Class</title>
        ...
        <meta property="og:title" content="Class 11 Math Tutor in Kolkata | Sucheta's Math Class" />
