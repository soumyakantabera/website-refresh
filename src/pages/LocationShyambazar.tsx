...
const LocationShyambazar = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Best Math Tutor in Shyambazar, Kolkata | 1:1 Private Coaching | Sucheta's Math Class</title>
        <meta name="description" content="Looking for math tutor in Shyambazar, Kolkata? Sucheta's Math Class offers 1:1 private tuition for CBSE, ICSE, WBBSE Classes 7-12 & BSc Maths. Online classes available. Call +91-6290871215" />
        ...
        <meta property="og:title" content="Best Math Tutor in Shyambazar | Sucheta's Math Class" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "name": "Sucheta's Math Class - Shyambazar",
