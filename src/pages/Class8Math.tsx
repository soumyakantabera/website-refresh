...
const Class8Math = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Class 8 Math Tutor in Kolkata | CBSE ICSE WBBSE | Math Class by Sucheta</title>
        ...
        <meta property="og:title" content="Class 8 Math Tutor in Kolkata | Math Class by Sucheta" />
