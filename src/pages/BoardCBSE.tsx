...
const BoardCBSE = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Best CBSE Math Tutor in Kolkata | Class 9-12 Math Coaching | Sucheta's Math Class</title>
        ...
        <meta property="og:title" content="Best CBSE Math Tutor in Kolkata | Sucheta's Math Class" />
